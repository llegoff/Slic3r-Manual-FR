...
Avant de se lansser tête baissée dans dans la production de la première impression, il est intéressant de s'arreter pour parler de l'importance d'obtenir une première couche parfaite. Comme beaucoup l'ont constaté par tâtonnements, si la première couche n'est pas le meilleur, cela peut alors conduire à un échec complet, parties se détachant, et déformation. Il existe plusieurs techniques et recommandations, don on peut tenir compte afin de minimiser le risque que cela se produise.
